...
predictor = dlib.shape_predictor(r"C:\Users\Dell\Desktop\Project\shape_predictor_68_face_landmarks.dat")
...
def main():
	cap = cv2.VideoCapture(r"C:\Users\Dell\Desktop\Project\video.mp4")
	sleep = 0
	drowsy = 0
	active = 0
	status=""
		...
		for face in faces:
			...
			if(left_blink==0 or right_blink==0):
				...
				if(sleep>6):
						...
						color = (255,0,0)
						mixer.init()
						mixer.music.load("C:/Users/Dell/Desktop/Project/sound_files/warning.mpeg")
						cv2.imwrite("C:/Users/Dell/Desktop/Project/dataset/frame_yawn%d.jpg"% sleep, frame)
						mixer.music.play()
				...
				if(drowsy>6):
						...
						color = (0,0,255)
						mixer.init()
						mixer.music.load("C:/Users/Dell/Desktop/Project/sound_files/warning_yawn.mpeg")
						mixer.music.play()
						while mixer.music.get_busy():  # wait for music to finish playing
							time.sleep(1)
			else:
